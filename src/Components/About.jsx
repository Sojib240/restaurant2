      ...
      <div className=" max-w-[1800px] mx-auto flex justify-between items-center gap-5 sm:gap-12 flex-wrap lg:flex-nowrap z-30">
        <div className="w-full lg:w-2/3">
          ...
          <p className="text-white text-base sm:text-lg font-JosefinSans_Regular text-center">
            Lazeez Arabic Restaurant and Grill is a premium Middle Eastern
            dining destination located in the heart of Bukit Bintang, Kuala
            Lumpur.
          </p>
          <p className="text-white text-base sm:text-lg font-JosefinSans_Regular text-center pt-2">
            We offer an authentic array of Arabic cuisine, with a menu that
            features traditional dishes, from succulent grilled kebabs to
            flavorful shawarma and fragrant biryanis. Whether you’re in the mood
            for a casual lunch, a festive dinner, or a special gathering with
            friends and family, Lazeez provides a warm and inviting atmosphere
            that brings the rich culinary traditions of the Middle East to
            Malaysia.
          </p>
          <p className="text-white text-base sm:text-lg font-JosefinSans_Regular text-center pt-2">
            Join us for a memorable dining experience and savor the true essence
            of Arabic flavors right here in Kuala Lumpur!!
          </p>
        </div>
